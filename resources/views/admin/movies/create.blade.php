    ...
    <div class="mb-8">
        <div class="flex items-center mb-6">
            <a href="{{ route('admin.movies.index') }}" 
               class="w-10 h-10 bg-gray-800 hover:bg-gray-700 rounded-lg flex items-center justify-center mr-4 transition-colors">
            ...
            <div>
                ...
                <p class="text-white mt-2">Create a new movie entry for your catalog</p>
            </div>
        </div>
    </div>
        ...
        <form action="{{ route('admin.movies.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="flex items-center">
                            <input type="checkbox" name="is_trending" id="is_trending" value="1"
                                   ...
                                   class="w-5 h-5 text-blue-600 bg-gray-600 border-gray-600 rounded focus:ring-blue-500 focus:ring-2">
                            <label for="is_trending" class="ml-3 text-sm font-medium text-gray-300">
                                Mark as trending movie
                            </label>
                        </div>
                        <p class="text-white text-sm mt-2">Trending movies will be highlighted in the catalog</p>
                        @error('is_trending')
                            <p class="text-red-500 text-sm mt-2 flex items-center">
                                <i class="fas fa-exclamation-circle mr-2"></i>{{ $message }}
                            </p>
            ...
            <div class="info-box">
                <h3 class="text-sm font-semibold text-white mb-3 flex items-center">
                    <i class="fas fa-info-circle mr-2"></i>Tips Informasi Film!
                </h3>
                <ul class="text-sm text-white space-y-2">
                    <li class="flex items-start">
                        <i class="fas fa-check-circle mr-2 mt-0.5 text-white"></i>
                        Gunakan gambar poster berkualitas tinggi untuk pengalaman visual yang lebih menyenangkan.
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle mr-2 mt-0.5 text-white"></i>
                        Tulis sinopsis yang menarik yang menggambarkan esensi film tersebut.
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle mr-2 mt-0.5 text-white"></i>
                        Cek dua kali rating dan durasi untuk memastikan.
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle mr-2 mt-0.5 text-white"></i>
                        Tandai film yang sedang trending untuk menunjukkannya pada pelanggan.
                    </li>
                </ul>
            </div>
