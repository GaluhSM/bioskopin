...
@section('content')
<div class="cinemas-create-container">
    <!-- Header -->
    <div class="mb-8">
        <div class="flex items-center mb-6">
            ...
            <div>
                ...
                <p class="text-white mt-2">Create a new cinema location in your network</p>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}"
                           ...
                           required>
                    <p class="text-white text-sm mt-2">Enter a descriptive name for the cinema location</p>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="location" id="location" value="{{ old('location') }}"
                           ...
                           required>
                    <p class="text-white text-sm mt-2">Complete address including city and postal code</p>
                    @error('location')
                        <p class="text-red-500 text-sm mt-2 flex items-center">
                            <i class="fas fa-exclamation-circle mr-2"></i>{{ $message }}
                        </p>
