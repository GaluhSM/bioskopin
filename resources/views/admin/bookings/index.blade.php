    ...
    <div class="stat-card" style="--gradient: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-3xl font-bold text-gray-800">{{ $bookings->where('status', 'pending_payment')->count() }}</p>
    ...
    <div class="stat-card" style="--gradient: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-3xl font-bold text-gray-800">{{ $bookings->where('status', 'paid')->count() }}</p>
    ...
    <div class="stat-card" style="--gradient: linear-gradient(135deg, #fc466b 0%, #3f5efb 100%);">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-3xl font-bold text-gray-800">{{ $bookings->where('status', 'cancelled')->count() }}</p>
